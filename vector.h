...
// you will need the uncomment this include if you want to use this library in normal C++ (for using the (u)intX_t datatypes)
//#include <cstdint>
...
public:
    /**
        ...
        *@return the function returns a reference of an element of 'array'. that way you can either read out the element or write to it
      */
    T& at(uint16_t index)
    {
